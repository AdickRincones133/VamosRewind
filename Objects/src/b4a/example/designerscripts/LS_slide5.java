...
views.get("slide_2").vw.setWidth((int)((40d / 100 * width)));
views.get("slide_2").vw.setHeight((int)((views.get("slide_2").vw.getWidth())));
views.get("slide_2").vw.setTop((int)(0d));
views.get("slide_2").vw.setLeft((int)((30d / 100 * width)));
views.get("slide_3").vw.setWidth((int)((30d / 100 * width)));
views.get("slide_3").vw.setHeight((int)((views.get("slide_3").vw.getWidth())));
views.get("slide_3").vw.setTop((int)((30d / 100 * height)));
views.get("slide_3").vw.setLeft((int)(0-(10d / 100 * width)));
views.get("slide_4").vw.setWidth((int)((30d / 100 * width)));
views.get("slide_4").vw.setHeight((int)((views.get("slide_4").vw.getWidth())));
views.get("slide_4").vw.setTop((int)((40d / 100 * height)));
views.get("slide_4").vw.setLeft((int)((views.get("pnlbackground").vw.getWidth())+(10d / 100 * width) - (views.get("slide_4").vw.getWidth())));
views.get("slide_5").vw.setWidth((int)((30d / 100 * width)));
views.get("slide_5").vw.setHeight((int)((views.get("slide_5").vw.getWidth())));
views.get("slide_5").vw.setTop((int)((60d / 100 * height)));
views.get("slide_5").vw.setLeft((int)((40d / 100 * width)));
