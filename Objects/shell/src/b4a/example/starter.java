...
public static b4a.example.m_funciones _m_funciones = null;
  public Object[] GetGlobals() {
		return new Object[] {"m_Funciones",Debug.moduleToString(b4a.example.m_funciones.class),"Main",Debug.moduleToString(b4a.example.main.class),"Rewind",Debug.moduleToString(b4a.example.rewind.class),"Service",starter.mostCurrent._service};
}
}